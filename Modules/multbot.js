var MultBot = class {
    ...
    setup = () => {
        ...
        // 👈 ALTERADO — botão do menu com "N" pequena, sem negrito (tamanho e cor fáceis de afinar)
        uw.$('.gods_area_buttons').append(`
            <div class='circle_button mult_bot_settings' onclick='window.multBot.settingsFactory.openWindow()'>
                <div style='width: 27px; height: 27px; display:flex; align-items:center; justify-content:center; font-size:13px; font-weight:normal; color:#fff; text-shadow:0 1px 2px rgba(0,0,0,0.8); font-family:Arial,Helvetica,sans-serif; line-height:1;' class='icon js-caption' title='MultBot'>
                    N
                </div>
            </div>
        `);
